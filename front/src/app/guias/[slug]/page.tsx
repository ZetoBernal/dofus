...
// Las traducciones al español se editan desde /admin sin pasar por un
// rebuild — esta página se revalida en background cada 60s en vez de
// quedar 100% estática, para que los cambios se reflejen sin redeploy.
...
export default async function GuidePage({ params }: Props) {
  ...
  const overridesMap = await getAllOverrides();
